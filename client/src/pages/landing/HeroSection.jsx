  ...
  return (
    <div className="flex justify-center bg-[#EEF7FB] w-full h-150 gap-30 pt-10">
      ...
      <div className="relative">
        ...
        <div className="w-30 h-40 bg-white rounded-xl shadow-sm shadow-gray absolute top-35 left-75 flex flex-col items-center">
            ...
            <button className="btn bg-gray-300 w-fit h-fit text-[8px] rounded-full mt-2.5 font-thin">จองเลย</button>
        </div>
        <div className="w-40 h-10 bg-white rounded-lg absolute top-60 right-70 flex justify-center items-center gap-3">
        ...
        <div className="w-50 h-25 bg-white rounded-lg absolute top-95 right-15">
          <p className="p-4 text-xs">พบกับแพทย์ของเรา</p>
