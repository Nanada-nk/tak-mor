function FAQCollapseComponent({
  question = "ฉันจะนัดหมายกับแพทย์ได้อย่างไร?",
  answer = `เพียงเข้าไปที่เว็บไซต์ของเราและเข้าสู่ระบบหรือสร้างบัญชี
  ...
  return (
    ...
    >
      ...
      <div className="collapse-content text-sm sm:text-base">{answer}</div>
    </div>
  );
}
